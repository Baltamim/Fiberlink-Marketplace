...
if(isset($_POST['order_btn'])){
   ...
   $address = mysqli_real_escape_string($conn, 'flat no. '. $_POST['flat'].',  '. $_POST['country'].' - '. $_POST['pin_code']);
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <select name="method">
               ...
               <option value="Bank Mandiri no. 006 000 439 0609 an. Tridaya Utama">Bank Mandiri no. 006 000 439 0609 an. Tridaya Utama</option>
               <option value="Bank BNI no. 0012964564 an. Tridaya Utama">Bank BNI no. 0012964564 an. Tridaya Utama</option>
               <!-- <option value="paytm">paytm</option> -->
            </select>
         </div>
      </div>
      <input type="submit" href="orders.php" value="order now" class="btn" name="order_btn">
   </form>
